	...
	if (collapsible === "none") {
		return (
			<div
				data-slot="sidebar"
				className={cn(
					"bg-sidebar text-sidebar-foreground flex h-screen w-(--sidebar-width) flex-col border-r",
					className,
				)}
				{...props}
			>
			...
			<div
				...
				className={cn(
					...
					variant === "floating" || variant === "inset"
						...
						: "group-data-[collapsible=icon]:w-(--sidebar-width-icon) group-data-[side=left]:border-e border-gray-200 group-data-[side=right]:border-s",
					className,
				)}
				{...props}
			>
...
function SidebarGroupLabel({
	...
	return (
		<Comp
			...
			className={cn(
				"text-gray-500 ring-sidebar-ring flex h-8 shrink-0 items-center rounded-md px-2 text-xs font-medium outline-hidden transition-[margin,opacity] duration-200 ease-linear focus-visible:ring-2 [&>svg]:size-4 [&>svg]:shrink-0",
...
const sidebarMenuButtonVariants = cva(
	"peer/menu-button flex w-full items-center gap-2 overflow-hidden rounded-md p-2 text-start text-gray-600 outline-hidden ring-sidebar-ring transition-[width,height,padding] focus-visible:ring-2 active:bg-[var(--primary-light)] active:text-[var(--sidebar-accent-foreground)] disabled:pointer-events-none disabled:opacity-50 group-has-data-[sidebar=menu-action]/menu-item:pe-8 aria-disabled:pointer-events-none aria-disabled:opacity-50 data-[active=true]:bg-[var(--primary-light)] data-[active=true]:font-semibold data-[active=true]:text-[var(--sidebar-accent-foreground)] data-[state=open]:hover:bg-[var(--primary-light)] data-[state=open]:hover:text-[var(--sidebar-accent-foreground)] group-data-[collapsible=icon]:size-8! group-data-[collapsible=icon]:p-2! [&>span:last-child]:truncate [&>svg]:size-4 [&>svg]:shrink-0 hover:bg-[var(--primary-light)] hover:text-[var(--sidebar-accent-foreground)] h-9 text-sm font-medium active",
	{
		variants: {
			variant: {
				default: "hover:bg-[var(--primary-light)] hover:text-[var(--sidebar-accent-foreground)]",
				outline:
					"bg-background shadow-[0_0_0_1px_hsl(var(--sidebar-border))] hover:bg-[var(--primary-light)] hover:text-[var(--sidebar-accent-foreground)] hover:shadow-[0_0_0_1px_hsl(var(--sidebar-accent))]",
			},
			size: {
				default: "h-9 text-sm",
				sm: "h-7 text-xs",
...
function SidebarMenuSub({ className, ...props }: React.ComponentProps<"ul">) {
	return (
		<ul
			...
			className={cn(
				"border-sidebar-border mx-3.5 flex min-w-max translate-x-px flex-col gap-1 border-s px-2.5 py-0.5",
				"group-data-[collapsible=icon]:hidden",
				className,
			)}
			{...props}
...
function SidebarMenuSubButton({
	...
	return (
		<Comp
			...
			data-active={isActive}
			className={cn(
				"text-gray-600 ring-sidebar-ring hover:bg-[var(--sidebar-accent)] hover:text-[var(--sidebar-accent-foreground)] active:bg-[var(--sidebar-accent)] active:text-[var(--sidebar-accent-foreground)] flex h-9 min-w-0 -translate-x-px items-center gap-2 overflow-visible rounded-md px-2 outline-hidden focus-visible:ring-2 disabled:pointer-events-none disabled:opacity-50 aria-disabled:pointer-events-none aria-disabled:opacity-50 [&>span:last-child]:whitespace-nowrap [&>svg]:size-4 [&>svg]:shrink-0 [&>svg]:text-inherit transition-colors duration-200 hover:font-medium",
